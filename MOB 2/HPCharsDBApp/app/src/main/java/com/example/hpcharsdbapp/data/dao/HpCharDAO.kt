package com.example.hpcharsdbapp.data.dao

import android.content.ContentValues
import android.content.Context
import android.database.Cursor
import com.example.hpcharsdbapp.data.db.DBHelper
...
class HpCharDAO(private val context: Context) {
    ...
    fun updateHPChar(hpChar: HPChar): Int {
        val db = dbHelper.writableDatabase
        val values = ContentValues().apply {
            put("name", hpChar.name)
            put("house", hpChar.house)
